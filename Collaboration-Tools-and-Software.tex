...
\begin{figure}
\includegraphics[width=0.2\linewidth,height=0.2\textheight]{tong} \caption{This is me!}\label{fig:unnamed-chunk-2}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.2\linewidth,height=0.2\textheight]{img_lida} \caption{This is me!}\label{fig:unnamed-chunk-3}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.2\linewidth,height=0.2\textheight]{Nilsa} \caption{This is me!}\label{fig:unnamed-chunk-6}
\end{figure}
