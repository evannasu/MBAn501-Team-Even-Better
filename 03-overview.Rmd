...
With a virtual tool that enables better communication and sharing of knowledge, it becomes easier to inspire each other. For example, a comment on a shared document that is visible to everyone may spark an idea in somebody else[@collaboration].
