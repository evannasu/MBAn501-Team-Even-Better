...
```{r echo=FALSE, fig.cap="Example of a GroupMe poll", out.width="50%", fig.align="center"}
knitr::include_graphics(rep("img/GroupMe2.png"))
```

```{r echo=FALSE, fig.cap="Examples of different discover groups", out.width="50%", fig.align="center"}
