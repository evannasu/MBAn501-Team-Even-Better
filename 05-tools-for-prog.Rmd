...
| Colab | - No setup, easy to write and execute python code. <br> - Useful team collaboration and project management tool. Just like collaborating on a Google Docs document, you can co-code with multiple developers using a Google Colab notebook.| - Limited space & time with the free version. <br> - Only for Python coders. |
...
After you add or edit files, you have to commit and push your changes to repository. Go to the right upper side of your RStudio and enter "Git". Then, select files and click "Commit", and you will need to select files again, input commit messages before you confirm your "Commit". 
  ...
  ```{r echo=FALSE, fig.cap="GitHub commit 1"}
knitr::include_graphics(rep("img/prog-gh-commit.png"))
```

```{r echo=FALSE, fig.cap="GitHub commit 2"}
...
```{r echo=FALSE, fig.cap="GitHub push"}
...
```{r echo=FALSE, fig.cap="GitHub pull"}
...
### More resources
- For more tutorials about GIT Push and Pull, please refer to [link](https://www.datacamp.com/tutorial/git-push-pull)
- For more advanced tutorials about Github, you can refer to [GitHub Tutorials](https://docs.github.com/en)
